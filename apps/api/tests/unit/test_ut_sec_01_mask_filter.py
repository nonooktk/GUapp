...
def test_ut_sec_01_mask_stripe_key() -> None:
    line = "key=sk_live_ABCdef0123456789XYZ done"  # pragma: allowlist secret  # gitleaks:allow
    out = _emit(SecretMaskFilter(), line)
...
def test_ut_sec_01_filter_keeps_args_structure_for_uvicorn_access_formatter() -> None:
    ...
    record = logger.makeRecord(
        ...
        (
            "127.0.0.1:1",
            "GET",
            "/api/v1/health?token=sk_live_ABC123",  # pragma: allowlist secret  # gitleaks:allow  # noqa: E501
            "1.1",
            200,
        ),
        None,
